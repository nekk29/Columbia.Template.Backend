...
### Example:
```bash
./generate-solution.sh "Company.Security" "security" "Security Apis"
```
...
### Example:
```bash
./GenerateSolution "Company.Security" "security" "Security Apis"
```
...
| ------- | --- |
| **Namespace** | The root namespace for all projects. Example: Company.Security |
